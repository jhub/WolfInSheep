...
\usepackage{glossaries} % Just here so I don't need to remove \gls{} from text when moving from my thesis
\input{glossary.tex}
...
Secure State Estimation requires a focus on all three of these pieces.
